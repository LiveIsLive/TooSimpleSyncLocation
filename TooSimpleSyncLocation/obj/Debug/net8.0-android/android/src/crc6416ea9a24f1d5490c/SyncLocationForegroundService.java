package crc6416ea9a24f1d5490c;


public class SyncLocationForegroundService
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TooSimpleSyncLocation.SyncLocationForegroundService, TooSimpleSyncLocation", SyncLocationForegroundService.class, __md_methods);
	}


	public SyncLocationForegroundService ()
	{
		super ();
		if (getClass () == SyncLocationForegroundService.class) {
			mono.android.TypeManager.Activate ("TooSimpleSyncLocation.SyncLocationForegroundService, TooSimpleSyncLocation", "", this, new java.lang.Object[] {  });
		}
	}
